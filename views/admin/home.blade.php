                ...
                <div class="list-group">
                    @foreach ( $activity as $item )
                        ...
                        @if ( $item->table == 'comments' )
                                <?php
                                    $icon = 'fa-comments';
                                    $author = Donatix\Blogify\Models\Comment::withTrashed()->find($item->row)->user->fullName;
                                ?>
                        ...
                        @if ( $item->table == 'categories' )
                                <?php
                                    $icon = 'fa-th-large';
                                    $category = Donatix\Blogify\Models\Category::withTrashed()->find($item->row);
                                ?>
                        ...
                        @if ( $item->table == 'tags' )
                                <?php
                                    $icon = 'fa-tags';
                                    $tag = Donatix\Blogify\Models\Tag::withTrashed()->find($item->row)
                                ?>
